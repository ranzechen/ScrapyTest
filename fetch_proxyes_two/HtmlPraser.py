# coding:utf-8
import base64
from fetch_proxyes_two.config import QQWRY_PATH, CHINA_AREA
from fetch_proxyes_two.util.IPAddress import IPAddresss
import re
from fetch_proxyes_two.util.compatibility import text_
